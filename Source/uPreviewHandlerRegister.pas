...
begin
  ...
  begin
    ...
    CreateRegKey(LRegKey, 'DisplayName', 'Delphi SKIA Preview Handler', RootKey);
    ...
    begin
      ...
      //Add extension of Preview for all animation files managed by Skia4Delphi
      LExtensions := GetSupportedExtensions(False);
      for LExtension in LExtensions do
        CreateRegKey(RootPrefix + LExtension + '\shellex\' + SID_IPreviewHandler, '', sClassID, RootKey);
  ...
  begin
    ...
    begin
      ...
      //Delete extension for all animation files managed by Skia4Delphi
      LExtensions := GetSupportedExtensions(False);
      for LExtension in LExtensions do
        DeleteRegKey(RootPrefix + LExtension + '\shellex\' + SID_IPreviewHandler, RootKey);
    end;
