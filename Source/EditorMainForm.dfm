object frmMain: TfrmMain
  ...
  object ActionList: TActionList
    ...
    object actnFormatJSON: TAction
      ...
      ImageName = 'Reformat'
      ShortCut = 16468
      OnExecute = actnFormatJSONExecute
      OnUpdate = actionForFileUpdate
    end
  ...
  object SaveDialog: TSaveDialog
    Filter = 
      'Lottie Image file (.lottie)|*.lottie|Lottie json file (.json)|*.' +
      'json'
  ...
  object VirtualImageList: TVirtualImageList
    Images = <
      ...
      item
        CollectionIndex = 48
        CollectionName = 'lottie-logo'
        Name = 'lottie-logo'
      end
      item
        CollectionIndex = 49
        CollectionName = 'lottie-logo-gray'
        Name = 'lottie-logo-gray'
      end
      item
        CollectionIndex = 50
