...
eng.UninstallMessage=An older version of "SKIA Shell Extensions and Lottie Text Editor"  was detected. The uninstaller will be executed...
ita.UninstallMessage=È stata rilevata una versione precedente di "SKIA Shell Extensions and Lottie Text Editor". Il programma di disinstallazione verrà eseguito...
[Tasks]
...
Name: "{commondesktop}\LottieTextEditor"; Filename: "{app}\LottieTextEditor.exe"; Tasks: desktopicon; Components: Editor
