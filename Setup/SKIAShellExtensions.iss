...
begin
  ...
  begin
    if (IsUpgrade()) then
    begin
      MsgBox(ExpandConstant('An old version of "SKIA Shell Extensions and Lottie Text Editor" was detected. The uninstaller will be executed...'), mbInformation, MB_OK);
      UnInstallOldVersion();
    end;
  end;
end;
